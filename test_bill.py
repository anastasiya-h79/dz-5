...
def test_run_bill():
    ...
    assert choice == '1' == int(input('Введите сумму'))
    assert choice == '2' == int(input('Введите сумму покупки'))
    assert choice == '3' == print(history)
    assert choice == '4' == sys.exit(0)
    assert choice == '5' == print('Неверный пункт меню')
